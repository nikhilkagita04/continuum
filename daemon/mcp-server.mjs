...
async function handle(req) {
  ...
  switch (method) {
    case 'initialize': {
      ...
      return { jsonrpc: '2.0', id, result: { protocolVersion: params?.protocolVersion || '2024-11-05', capabilities: { tools: {} }, serverInfo: { name: 'continuum', version: '0.7.0' }, instructions } };
    }
    case 'tools/list':
